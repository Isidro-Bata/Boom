            ...
            try{
                ...
                if(scc==true){
                    ...
                    if(scc==true){
                        ...
                        ctrEmp.newEmprestimo(Integer.parseInt(Id.getText()), Integer.parseInt(inID.getText()), 6, Float.parseFloat(inCred.getText()), Float.parseFloat(inVt.getText())
